...
exports.indexGetFunction = function(req,res){
    Log.find({}, haveLog);
 ...
 * Help route.
 */
exports.helpGetFunction = function (req, res) {
    var options = {
        title: 'Help Page'
    };
 ...
 */
exports.leafletExampleGetFunction = function (req, res) {
    var options = {
 ...
 */
exports.graphicFormGetFunction = function (req, res) {
 ...
 * GET Learn
 */
exports.learnGetFunction = function (req, res) {
    var options = {
        title: 'Learn'
    };
 ...
 * GET Add data
 */
exports.addDataGetFunction = function (req, res) {
    var options = {
        title: 'Add data',
        error: 'NO',
 ...
 * POST Add data
 */
exports.addDataPostFunction = function (req, res) {
 ...
 * GET Delete data
 */
exports.deleteDataGetFunction =  function (req, res) {
 ...
 * POST Delete data
 */
exports.deleteDataPostFunction =  function (req, res) {
 ...
 */
exports.graphicFormPostFunction =  function (req, res) {
    var c = new Graphic(),
        d = new District(),
        votes = [],
        resultados = [],
